    ...
    <>
      ...
      {!open && (
        <button
          ...
          className="fixed bottom-8 right-8 z-40 hidden h-14 w-14 items-center justify-center rounded-full bg-[var(--color-cta)] text-[var(--color-cta-ink)] shadow-lg transition-all hover:scale-105 hover:bg-[var(--color-cta-deep)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent)] focus-visible:ring-offset-2 xl:flex"
        >
          <svg
            width="24"
            height="24"
