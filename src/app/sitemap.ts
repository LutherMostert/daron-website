...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: Array<{ path: string; priority: number; cf: ChangeFreq }> = [
    ...
    { path: "/group-network", priority: 0.8, cf: "monthly" },
    { path: "/solutions", priority: 0.8, cf: "monthly" },
    { path: "/solutions/vessel-reactivation", priority: 0.8, cf: "monthly" },
    { path: "/solutions/planned-maintenance", priority: 0.8, cf: "monthly" },
    { path: "/solutions/remote-site-supply", priority: 0.8, cf: "monthly" },
    { path: "/procurement-resources", priority: 0.7, cf: "monthly" },
    { path: "/services/ship-chandlery", priority: 0.9, cf: "monthly" },
    { path: "/services/dry-dock", priority: 0.7, cf: "monthly" },
    { path: "/services/coatings", priority: 0.8, cf: "monthly" },
