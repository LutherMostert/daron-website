        ...
        <Container>
          <ul className="grid gap-8 md:grid-cols-2">
            {posts.map((post) => (
              ...
              >
                <div className="flex items-center justify-between text-xs font-semibold uppercase tracking-[0.2em] text-[var(--color-orange)]">
                  <span>{post.category}</span>
                  <time dateTime={post.date}>
                    {formatter.format(new Date(post.date))}
                  </time>
                </div>
                <h2 className="mt-4 font-[family-name:var(--font-poppins)] text-xl font-bold leading-snug text-[var(--color-navy)] group-hover:text-[var(--color-orange)] sm:text-2xl">
                ...
                <Link
                  ...
                  className="mt-5 inline-flex items-center font-semibold text-[var(--color-navy)] underline-offset-4 group-hover:text-[var(--color-orange)] group-hover:underline"
